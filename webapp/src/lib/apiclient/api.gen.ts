...
export const WebRPCSchemaHash = "79351a0174d06e6c66b80ad3609d1adbf1f281a8"
...
export interface ETHGas {
  ...
  getPriceUSD(args: GetPriceUSDArgs, headers?: object): Promise<GetPriceUSDReturn>
...
export interface GetPriceUSDArgs {
  chainId: string
}

export interface GetPriceUSDReturn {
  priceUSD: PriceUSD  
}
...
export class ETHGas implements ETHGas {
  ...
  getPriceUSD = (args: GetPriceUSDArgs, headers?: object): Promise<GetPriceUSDReturn> => {
    return this.fetch(
      this.url('GetPriceUSD'),
      createHTTPRequest(args, headers)).then((res) => {
      return buildResponse(res).then(_data => {
        return {
          priceUSD: <PriceUSD>(_data.priceUSD)
        }
      })
    })
  }
