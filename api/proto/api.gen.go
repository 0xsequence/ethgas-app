...
func WebRPCSchemaHash() string {
	return "2af5fca4ffe6567826963187d6e359cb513fb08c"
}
...
type ETHGas interface {
	...
	SuggestedGasPrice(ctx context.Context) (*SuggestedGasPrice, error)
	AllSuggestedGasPrices(ctx context.Context, count *uint) ([]*SuggestedGasPrice, error)
	AllGasStats(ctx context.Context, count *uint) ([]*GasStat, error)
	GasPriceHistory(ctx context.Context) (map[uint64][]uint64, error)
}
...
func (s *eTHGasServer) serveSuggestedGasPriceJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.ETHGas.SuggestedGasPrice(ctx)
	}()
	respContent := struct {
...
func (s *eTHGasServer) serveAllSuggestedGasPricesJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.ETHGas.AllSuggestedGasPrices(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *eTHGasServer) serveAllGasStatsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.ETHGas.AllGasStats(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *eTHGasServer) serveGasPriceHistoryJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.ETHGas.GasPriceHistory(ctx)
	}()
	respContent := struct {
...
func (c *eTHGasClient) SuggestedGasPrice(ctx context.Context) (*SuggestedGasPrice, error) {
	out := struct {
		Ret0 *SuggestedGasPrice `json:"suggestedGasPrice"`
	}{}
...
func (c *eTHGasClient) AllSuggestedGasPrices(ctx context.Context, count *uint) ([]*SuggestedGasPrice, error) {
	in := struct {
		Arg0 *uint `json:"count"`
	}{count}
	out := struct {
...
func (c *eTHGasClient) AllGasStats(ctx context.Context, count *uint) ([]*GasStat, error) {
	in := struct {
		Arg0 *uint `json:"count"`
	}{count}
	out := struct {
...
func (c *eTHGasClient) GasPriceHistory(ctx context.Context) (map[uint64][]uint64, error) {
	out := struct {
		Ret0 map[uint64][]uint64 `json:"gasPriceHistory"`
	}{}
